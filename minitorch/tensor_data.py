...
def shape_broadcast(shape1: UserShape, shape2: UserShape) -> UserShape:
    ...
    """
    # new_len = max(len(shape1), len(shape2))
    # new_shape = []
    ...
    #     shape1_dim = 1
    #     if i < len(shape1):
    #         shape1_dim = shape1[at]

    #     shape2_dim = 1
    #     if i < len(shape2):
    #         shape2_dim = shape2[at]

    #     if shape1_dim == shape2_dim:
    #         new_shape.append(shape1_dim)
    #     elif shape1_dim == 1:
    #         new_shape.append(shape2_dim)
    #     elif shape2_dim == 1:
    #         new_shape.append(shape1_dim)
    #     else:
    #         raise IndexingError(
    #             "Cannot broadcast shapes: " + str(shape1) + " and " + str(shape2)
    #         )
...
class TensorData:
    ...
    def index(self, index: Union[int, UserIndex]) -> int:
        """Convert a multi-dimensional index into a single-dimensional position in storage."""
    ...
    def indices(self) -> Iterable[UserIndex]:
        """Return all valid indices in the tensor."""
